#include <wrkr/hdr/gn_conn_mgmt_thrd_conf_list_remove.h>
...
void
gn_conn_mgmt_thrd_conf_list_remove (gn_conn_mgmt_thrd_conf_list_s * const list,
                                    const gn_conn_mgmt_thrd_conf_s * const conf)
{
  switch (list->len) {
    case 0: {
      return;
